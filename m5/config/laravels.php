...
return [
    ...
    'swoole_tables'            => [],
    'register_providers'       => [
        App\Providers\ServiceCallProvider::class,
    ],
    'cleaners'                 => [
        App\Cleansrs\ApiDbCleaner::class,
        App\Cleansrs\NeigouLoggerCleaner::class,
    ...
    'swoole'                   => [
        ...
        'worker_num'              => env('LARAVELS_WORKER_NUM',
            function_exists('swoole_cpu_num') ? swoole_cpu_num() * 6 : 8),
        ...
        'memory_limit'            => env('LARAVELS_MEMORY_LIMIT', 256 * 1024 * 1024),
