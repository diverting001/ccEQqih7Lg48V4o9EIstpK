...
class NG implements ScopeAdapterInterface
{
    ...
    public function update( $thirdUniqueCode, $params )
    {
        ...
        $response = $this->_request( 'MemberScope', 'editRuleItems', $post );
    ...
    public function getScopeByRuleBnsAndIdentify( $thirdUniqueCodes, $identifyData )
    {
        $post = [
            ...
            'member_keys' => $identifyData,
        ];

        $response = $this->_request( 'MemberScope', 'identifyRuleItems', $post );
