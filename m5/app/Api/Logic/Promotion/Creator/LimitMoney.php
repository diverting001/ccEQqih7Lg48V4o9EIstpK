...
class LimitMoney implements RuleCreatorInterface
{
    ...
    public function generate($data)
    {
        ...
        $condition['operator_class'] = $this->_processor_name;  //促销类 :赠品 present｜ 免邮 free_shipping｜ 限购 limit_buy | 限额 limit_money
