...
class ResourceController extends BaseController
{
    ...
    public function getResourceList(Request $request)
    {
        ...
        // 保存分销商信息
        $resourceList = $resourceService->getResourceList($object, $objectItem, $status, $page, $pageSize);
    ...
    public function lock(Request $request)
    {
        ...
        $errMsg = '';
        $result = $resourceService->lockResource($object, $objectItem, $resource, $resourceItem, $resourceValue, $memo, $errMsg);
