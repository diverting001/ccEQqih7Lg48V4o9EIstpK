...
require_once dirname(dirname(__DIR__)). '/lib/php/lib/Thrift/ClassLoader/ThriftClassLoader.php';

$GEN_DIR =  dirname(__DIR__).'/gen-php';
$loader = new ThriftClassLoader();
$loader->registerNamespace('Thrift', dirname(dirname(__DIR__)). '/lib/php/lib');
